...
{
    /**
     * Creates and Tests SortedWordList class
     * @param args no args
     */
 ...
 * names1 = [Amy, Barb, Connie, Dan, Ellen, Frank] contains("Amy") = false
 * indexOf("Amy") = -1 contains("Ben") = false indexOf("Ben") = -1
 * contains("Dan") = false indexOf("Dan") = -1 names2 = [Aaron, Amy, Ben,
 * Claire, Connie, Debby, Eve, Fiona, Frank, Gina] names1 + names2 = [Aaron,
 * Amy, Barb, Ben, Claire, Connie, Dan, Debby, Ellen, Eve, Fiona, Frank, Gina]
 * [Aaron, Amy, Barb, Ben, Claire, Connie, Dan, Debby, Ellen, Eve, Fiona, Frank,
 * Gina]
 */

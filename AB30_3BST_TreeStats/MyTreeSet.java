...
public class MyTreeSet<E>
{
    ...
    private int height( TreeNode<E> root )
    {
        ...
        {
            return max( height( root.getLeft() ) + 1, height( root.getRight() ) + 1 );
        }
    }
    ...
    private void interchange( TreeNode<E> root )
    {
        ...
        {
            TreeNode<E> rootR = root.getRight();
            TreeNode<E> rootL = root.getLeft();
    ...
    private int[] nodeCounts( TreeNode<E> root )
    {
        ...
        else
        {
            ...
            result[1] = Math
                .abs( countNodesHelper( temp.getRight() ) - countNodesHelper( temp.getLeft() ) );
    ...
    private void accumulate( TreeNode<Integer> root )
    {
        ...
        {
            val += root.getLeft().getValue();
        }

        if ( root.getRight() != null )
        {
            val += root.getRight().getValue();
        }

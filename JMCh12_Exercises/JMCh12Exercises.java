...
public class JMCh12Exercises
{
    ...
    public boolean[] prob2abcdTrueFalse()
    {
        ...
        // to question (a) - (d)
        /*
         * a) Only has 100 elements (from 0 to 99) b) With autoboxing, Java
         * automatically converts Integer to int c) It checks if subscript is
         * within the length of array d) Arrays don't have length methods, but
         * rather a length field that returns the size of the array
         */
    ...
    {
        char[] array = { 'r', 'r', 'r', 'p', 'p', 'p', 'p', 'p', 's', 's', 's', 's', 's', 's' };
    ...
    public String whatDoesMysteryCountCount()
    {
        ...
        String answer = mCount + " the number of 0's before a number " + "other than 0 occurs";
    ...
    public boolean[] prob11abcdeTrueFalse()
    {
        ...
        // to question (a) - (e)
        /*
         * a) does not check if equal when adding objects, so can have multiple
         * references to the exact same object b) two arraylists can have the
         * same object in their lists c) the object still exists when the
         * ArrayList removes it; it just will no be referred to in the ArrayList
         * d) An ArrayList's add method doesn't copy the object e) Yes, two
         * variables can refer to the same ArrayList
         */
    ...
    public void removeMin( ArrayList<Integer> list )
    {
        ...
        {
            int diff = list.get( i ).compareTo( min );
            if ( diff < 0 )
            {
                min = list.get( i );
            }
    ...
    public boolean isMedian( double[] sample, double m )
    {
        ...
        return ( larger == smaller ); // TODO fix this!!
    }
    ...
    public static boolean covers( double[][] m1, double[][] m2 )
    {
        ...
        return ( num >= m1.length * m1[0].length / 2.0 );
    }

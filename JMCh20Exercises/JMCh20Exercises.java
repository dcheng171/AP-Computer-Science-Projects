...
public class JMCh20Exercises<E>
{
    ...
    {
        ListNode<E> newVal = new ListNode<E>( value, null );
        if ( head == null )
        {
            head = newVal;
            return head;
    ...
    public ListNode<E> reverseList( ListNode<E> head )
    {
        ...
        ListNode<E> temp1 = new ListNode<E>( head.getValue(), null );
        ListNode<E> temp2 = new ListNode<E>( head.getValue(), null );

        for ( ListNode<E> temp = head; temp != null; temp = temp.getNext() )
        {
            if ( temp == head )
            {
                temp1 = new ListNode<E>( head.getValue(), null );
            }
            else
            {
                temp1 = new ListNode<E>( temp.getValue(), temp2 );
            }
     ...
     * 
     * <pre>
     *     <code>public ListNode concatenateStrings(ListNode head)
     * </code>
     * </pre>
     * 
    ...
    public ListNode<String> concatenateStrings( ListNode<String> head )
    {
        ...
        for ( ListNode<String> temp = head.getNext(); temp != null; temp = temp.getNext() )
        {
    ...
    public ListNode<E> rotate( ListNode<E> head )
    {
        ...
        ListNode<E> temp;
        for ( temp = newHead; temp != null; temp = temp.getNext() )
        {
            if ( temp.getNext() == null )
            {
                break;
     ...
     * 
     * <pre>
     *    <code>public ListNode insertInOrder(ListNode head, String s)
     * </code>
     * </pre>
     * 
    ...
    public ListNode<String> insertInOrder( ListNode<String> head, String s )
    {
        ...
        ListNode<String> newN = new ListNode<String>( s, temp );
     ...
     * 
     * <pre>
     *   <code>public ListNode moveToBack(ListNode head, String pattern)
     * </code>
     * </pre>
     * 
    ...
    {
        ListNode<String> fNode = head;

        while ( fNode != null )
        {
            ListNode<String> minNode = fNode;
            for ( ListNode<String> temp = fNode.getNext(); temp != null; temp = temp.getNext() )
            {
                String s = temp.getValue();
                if ( s.compareTo( minNode.getValue() ) < 0 )
                {
                    minNode = temp;
                }
            }

            String minStr = minNode.getValue();
            minNode.setValue( fNode.getValue() );
            fNode.setValue( minStr );
     ...
     * 
     * <pre>
     *   <code>public void quickSort(ListNode2 fromNode, ListNode2 toNode)
     * </code>
     * </pre>
     * 
